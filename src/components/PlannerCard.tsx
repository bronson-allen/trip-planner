...
export default function PlannerCard({ open, onClose, onSubmit }: PlannerCardProps) {
  const titleId = useId()
    ...
    <div className="planner-overlay" onClick={onClose}>
      ...
      >
        ...
        <form className="planner-card__form" onSubmit={handleSubmit}>
          ...
          <div className="planner-field">
            <label className="planner-field__label" htmlFor="planner-notes">
              Anything else?{' '}
              <span className="planner-field__optional">optional</span>
            </label>
            <textarea
              id="planner-notes"
              ...
              placeholder="e.g. no seafood, traveling with a stroller, keep day 3 light..."
            />
            <p className="planner-notes__hint">
              Only for things chips can&apos;t capture — exclusions, constraints,
              context for the day.
            </p>
          </div>
